            ...
            <div>
                ...
                <div className="content-section implementation">
                    <DataTable value={this.state.palpites} paginator={true} rows={10} header={header}
                        ...
                        <Column field="terceiro" header="Terceiro" filter={true} filterElement={campeaoFilter} filterMatchMode="equals" />
                        <Column field="quarto" header="Quarto" filter={true} filterElement={campeaoFilter} filterMatchMode="equals" />
                    </DataTable>
                </div>
            </div>
        );
